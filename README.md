...
3. [Обучение моделей](#обучение-моделей)
   - [cointegrated/rubert-tiny2](#cointegrated%2Frubert-tiny2)
   - [Tochka-AI/ruRoPEBert-e5-base-2k](#tochka-ai%2Fruropebert-e5-base-2k)
   - [unsloth/gemma-2-9b-it-bnb-4bit](#unsloth%2Fgemma-2-9b-it-bnb-4bit)
